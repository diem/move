...
[Move repository](https://github.com/diem/move). It may be installed in one of two ways:

1. Clone [the Move repository](https://github.com/diem/move) yourself and build
...
2. Use Rust's package manager `cargo` to install `move-analyzer` in your user's PATH. This
   is recommended for people who do not work on Diem & Move.
