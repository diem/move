...
module This::IncrDecrStateMachine {

    use Async::Actor::{self, epoch_time};
    use Std::Vector;

    const MAX: u64 = 43;
    const MAX_TRANSFER_AGE: u64 = 100000000;
    ...
    #[_generated_send]
    public native fun send_deposit(dest: address, v: u64);
    public native fun send_withdraw(dest: address, v: u64);
    public native fun send_xfer(dest: address, a: address, v: u64);
    public native fun send_xfer_deposit(dest: address, v: u64, a: address, id: u64);
    public native fun send_xfer_finish(dest: address, id: u64);
    public native fun send_cleanup(dest: address);
}
